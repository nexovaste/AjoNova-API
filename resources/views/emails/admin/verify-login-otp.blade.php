...
<head>
    ...
    <style>
        ...
        /* Body - General text is Left Aligned */
        ...
        @media only screen and (max-width: 600px) {
            ...
            .header-title { font-size: 18px !important; letter-spacing: 0.5px !important; }
            .header-subtitle { font-size: 10px !important; letter-spacing: 1px !important; }
            .logo-cell { width: 55px; }
            .logo-cell img { width: 50px; }
            .email-body { padding: 30px 20px; }
            .otp-code { font-size: 28px !important; letter-spacing: 4px !important; }
            .otp-container { min-width: 80%; }
        }
    </style>
</head>
    ...
    <div class="email-wrapper">
        <div class="email-container">
            ...
            <div class="email-body">
                ...
                <p>To continue, please enter the following One-Time Password (OTP) on the verification screen.</p>

                <div class="otp-box-wrapper">
                    <div class="otp-container">
                        <span class="otp-label">Verification Code</span>
                        <h1 class="otp-code">{{ $otp }}</h1>
                        <span class="timer-notice">⏱ Expires in 10 minutes</span>
                    </div>
                </div>

                <p style="font-size: 14px; color: #64748b;">If you did not attempt to sign in, please ignore this email or contact support.</p>
